...
namespace Aardwolf
{
    public partial class Form1 : Form
    {
        ...
        {
            // [Dash|RD] I didn't orginally know where this was going to be placed, whether the gamesession starts outside of the renderer, or inside it.
            //           Outside seems best for now, but it'll require some refactoring of the renderer.
            dataHandler dh = _gamesession.TEST_getDataHandler();
